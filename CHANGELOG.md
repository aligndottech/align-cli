...
* **local:** stop fabricating status: 'active' on every local search result (ALI-1063 follow-up) ([#292](https://github.com/aligndottech/align-cli/issues/292)) ([f4ab56f](https://github.com/aligndottech/align-cli/commit/f4ab56fed7e04225a9de41d749c6a6060851d74f))
* **test:** match with a herestring so pipefail cannot invert the result (ALI-995) ([#291](https://github.com/aligndottech/align-cli/issues/291)) ([5cb75dd](https://github.com/aligndottech/align-cli/commit/5cb75dd72eb48f6ebf01c5710421ca6a32477426))
